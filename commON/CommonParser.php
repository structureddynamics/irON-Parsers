          ...
          if(substr($type["&mapTo"][0], 0, 7) != "http://")
          {
            ...
            if($pos !== FALSE)
            {
              ...
              foreach($this->commonLinkageSchema["prefixes"] as $keyPrefix => $pref)
              {
                ...
                {
                  $this->commonLinkageSchema["types"][$keyType]["&mapTo"][0] = str_replace($pref["&prefixList"][0].":", $this->commonLinkageSchema["prefixes"][$keyPrefix]["&mapTo"][0], $this->commonLinkageSchema["types"][$keyType]["&mapTo"][0]);
                }
              }
            }
          }
          ...
          if(substr($property["&mapTo"][0], 0, 7) != "http://")
          {
            ...
            if($pos !== FALSE)
            {
              ...
              foreach($this->commonLinkageSchema["prefixes"] as $keyPrefix => $pref)
              {
                if($pref["&prefixList"][0] == $prefix)
                {
                  $this->commonLinkageSchema["properties"][$keyProperty]["&mapTo"][0] = str_replace($pref["&prefixList"][0].":", $this->commonLinkageSchema["prefixes"][$keyPrefix]["&mapTo"][0], $this->commonLinkageSchema["properties"][$keyProperty]["&mapTo"][0]);
                }
              }
            }
          }
